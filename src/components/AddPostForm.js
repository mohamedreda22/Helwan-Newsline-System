...
//       formData.append("post_content", PostContent); // Add post content
//       formData.append("category_id", selectedCategory); // Add category ID
//       formData.append("source_id", selectedSource); // Add source ID
//       formData.append("post_image", image); // Add image data

//       const response = await axios.post(
//         "http://localhost:9090/university/posts",
//         formData, // Send FormData object instead of a JSON object
//         {
//           headers: {
