...
const ArticleByDetails = () => {
    ...
    const fetchComments = async () => {
        try {
            const response = await axios.get(`http://localhost:9090/university/articles/${article_id}/comments`);
    ...
    const handleCommentSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`http://localhost:9090/university/articles/${article_id}/comments`, {
    ...
    return ( 
        <div>
            ...
            <div className="comments-section">
                <h3 className="comment-heading">التعليقات</h3>
